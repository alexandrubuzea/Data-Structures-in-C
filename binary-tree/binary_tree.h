...
/* A function that returns the height (the number of levels on
 * which there are existing nodes in the binary tree) - task 2
 */

int
b_tree_height(b_tree_t *tree);

/* A function that returns the LCA - task 2 bonus
 */
